...
//to create beans
	...
	public DataSource getDataSource() {
	    ...
	    dataSource.setUrl("jdbc:h2:tcp://localhost/~/perfume");
	...
	*/
	...
	public SessionFactory sessionFactory() {
		...
		hibernateProperties.setProperty("hibernate.hbm2ddl.auto", "update"); //creates or validates db table //update- used to update the table
		hibernateProperties.setProperty("hibernate.show_sql", "true"); //for runtime update
